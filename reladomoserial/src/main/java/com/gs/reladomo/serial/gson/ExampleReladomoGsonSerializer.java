...
public class ExampleReladomoGsonSerializer<T extends MithraObject> implements JsonSerializer<T>
{
    ...
    public JsonElement serialize(T t, Type type, JsonSerializationContext jsonSerializationContext)
    {
        ...
        MithraObject reladomoObject = (MithraObject) t;
        RelatedFinder finder = t.zGetPortal().getFinder();
        ReladomoSerializationContext reladomoSerializationContext = new ReladomoSerializationContext(SerializationConfig.shallowWithDefaultAttributes(finder), new ExampleGsonSerialWriter(result));
