...
public class ExampleGsonReladomoSerializerTest extends TestTrivialJson
{
    @Override
    protected String toJson(Serialized serialized) throws Exception
    {
        return register().toJson(serialized);
    }

    private Gson register()
    {
        final GsonBuilder gsonBuilder = new GsonBuilder();
        gsonBuilder.registerTypeAdapter(Serialized.class, new GsonWrappedSerializer());
